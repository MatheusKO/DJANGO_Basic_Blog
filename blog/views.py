...
blog_posts = [
    {
        ...
        "author": "MatheusKO",
        "last_update": date(2021, 9, 10),
        "content": """
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Odio tempor orci dapibus ultrices in iaculis.
            Mauris sit amet massa vitae tortor condimentum lacinia quis. Ac turpis egestas maecenas pharetra convallis. Diam in arcu cursus euismod quis viverra nibh cras pulvinar. Consectetur purus ut faucibus pulvinar. Dignissim diam quis enim lobortis scelerisque. Tortor pretium viverra suspendisse potenti nullam. Dui sapien eget mi proin sed libero. Auctor elit sed vulputate mi sit amet. Vulputate ut pharetra sit amet aliquam id diam maecenas.
            Orci dapibus ultrices in iaculis nunc sed augue lacus. Netus et malesuada fames ac. Orci ac auctor augue mauris augue. Magna fringilla urna porttitor rhoncus dolor purus non enim praesent. Feugiat pretium nibh ipsum consequat. Porttitor eget dolor morbi non. At tellus at urna condimentum mattis pellentesque id nibh.
            Aliquam purus sit amet luctus. Magna fringilla urna porttitor rhoncus dolor purus non. Placerat orci nulla pellentesque dignissim. Integer quis auctor elit sed vulputate. Eleifend donec pretium vulputate sapien nec sagittis aliquam malesuada bibendum. Luctus accumsan tortor posuere ac ut. Euismod in pellentesque massa placerat duis ultricies lacus sed turpis. Eu consequat ac felis donec et odio pellentesque diam volutpat.
...
def index(request):
    ...
    for post in latest_posts:
        ...
        latest_posts_info.append(extracted_dict)

    return render(request, "blog/index.html", {
        "posts": latest_posts_info
    })
